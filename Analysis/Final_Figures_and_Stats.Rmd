...
x <- c("tidyverse", "plyr", "vegan", "lubridate", "readxl", "ggthemes", "ggrepel", "extrafont", "nlme")
...
bugndiet.fam <- readxl::read_xlsx("./Data/2017-18 bugs.xlsx", sheet = "Benthic and Diet", range = "P1:V125")
bugndiet.ffg <- readxl::read_xlsx("./Data/2017-18 bugs.xlsx", sheet = "Benthic and Diet", range = "AA1:AF54")
...
write_csv(scraper_agg, "~/Desktop/scraper_agg.csv")
```
