...
```{r Total Average Log Ratio, echo = 
FALSE, fig.height=10, fig.width=12}
avg.ratio <- ffg.ratios %>% group_by(Stream, Treatment) %>% summarise_at(vars(Difference, Ratio, `Log(Ratio) Year`), mean)
