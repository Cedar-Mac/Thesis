...
```{r Bentho torch Both Years, fig.height = 8, fig.width = 12, echo = TRUE}
# Change variables to factors.  Re-order with CHUCK at the end
...
```{r Total Densities, fig.height=10, fig.width=12, echo = TRUE}
...
```{r Density Diffs, fig.height=10, fig.width=12, echo = TRUE}
...
```{r FFG Densities, fig.height=10, fig.width=12, echo = TRUE}
...
```{r Terrestrial Vs. Aquatic, fig.height=8, fig.width=12, echo = TRUE}
