...
## Run 1 stress 0.1049412 
## Run 2 stress 0.104941 
## Run 3 stress 0.09448762 
## ... New best solution
## ... Procrustes: rmse 0.03044068  max resid 0.1042538 
## Run 4 stress 0.1006329 
## Run 5 stress 0.09937405 
## Run 6 stress 0.1033953 
## Run 7 stress 0.103675 
## Run 8 stress 0.09800239 
## Run 9 stress 0.09895509 
## Run 10 stress 0.09448744 
## ... New best solution
## ... Procrustes: rmse 6.278709e-05  max resid 0.0002128984 
## ... Similar to previous best
## Run 11 stress 0.1036777 
## Run 12 stress 0.100633 
## Run 13 stress 0.09746161 
## Run 14 stress 0.1033862 
## Run 15 stress 0.09448717 
## ... New best solution
## ... Procrustes: rmse 0.0008235412  max resid 0.002951428 
## ... Similar to previous best
## Run 16 stress 0.09895805 
## Run 17 stress 0.09896018 
## Run 18 stress 0.1033864 
## Run 19 stress 0.100633 
## Run 20 stress 0.09895769 
## *** Solution reached
```
...
bugndiet %>% 
  ...
  ggplot(aes(x = frac.benthic, y = frac.diet, color = Treatment)) +
    ...
    geom_text_repel(aes(x = frac.benthic, y = frac.diet, label = FFG), size = 9, face = "bold", point.padding = 1, box.padding = .5) +
...
## Run 1 stress 0.1284668 
## ... New best solution
## ... Procrustes: rmse 0.0006013098  max resid 0.001420743 
## ... Similar to previous best
## Run 2 stress 0.1204535 
## ... New best solution
## ... Procrustes: rmse 0.2198304  max resid 0.4824903 
## Run 3 stress 0.1284667 
## Run 4 stress 0.1204533 
## ... New best solution
## ... Procrustes: rmse 0.0004861183  max resid 0.00105495 
## ... Similar to previous best
## Run 5 stress 0.1284667 
## Run 6 stress 0.1284667 
## Run 7 stress 0.319569 
## Run 8 stress 0.1204532 
## ... New best solution
## ... Procrustes: rmse 0.0002382401  max resid 0.0005044729 
## ... Similar to previous best
## Run 9 stress 0.1204534 
## ... Procrustes: rmse 0.0002756115  max resid 0.000643786 
## ... Similar to previous best
## Run 10 stress 0.1204533 
## ... Procrustes: rmse 0.0001893912  max resid 0.0004144549 
## ... Similar to previous best
## Run 11 stress 0.1204535 
## ... Procrustes: rmse 0.0003524649  max resid 0.0008346821 
## ... Similar to previous best
## Run 12 stress 0.1204533 
## ... Procrustes: rmse 0.0003790449  max resid 0.0008381421 
## ... Similar to previous best
## Run 13 stress 0.1284666 
## Run 14 stress 0.3155578 
## Run 15 stress 0.1284668 
## Run 16 stress 0.2467805 
## Run 17 stress 0.1204532 
## ... New best solution
## ... Procrustes: rmse 0.00014437  max resid 0.0002226233 
## ... Similar to previous best
## Run 18 stress 0.1204532 
## ... Procrustes: rmse 0.0002009578  max resid 0.0004125556 
## ... Similar to previous best
## Run 19 stress 0.1204532 
## ... Procrustes: rmse 3.722707e-05  max resid 6.045193e-05 
## ... Similar to previous best
## Run 20 stress 0.128467 
## *** Solution reached
```
