...
![](index_files/figure-html/Chla Post-1.png)<!-- -->
...
ggplot(data = bentho_both.mean) +
  ...
  scale_color_viridis_d(option = "E") +
  facet_wrap("Stream") +
  theme(legend.position = c(.86, .2), legend.key.width = unit(5, "cm"),
        aspect.ratio = 1)
```
...
ggplot(aes(x = FFG, y = Diff, fill = Treatment)) + 
  ...
  scale_fill_viridis_d(option = "E") +
  theme(legend.position = c(.84, .8), legend.key.size = unit(2, "cm")) +
  coord_flip()
```

![](index_files/figure-html/FFG Density Differences-1.png)<!-- -->
...
## Run 1 stress 0.09894067 
## Run 2 stress 0.09528897 
## ... New best solution
## ... Procrustes: rmse 0.0003933256  max resid 0.000765891 
## ... Similar to previous best
## Run 3 stress 0.09800189 
## Run 4 stress 0.09448782 
## ... New best solution
## ... Procrustes: rmse 0.03058146  max resid 0.1048159 
## Run 5 stress 0.1036826 
## Run 6 stress 0.1031141 
## Run 7 stress 0.09800223 
## Run 8 stress 0.1049419 
## Run 9 stress 0.09448681 
## ... New best solution
## ... Procrustes: rmse 0.000541544  max resid 0.00192648 
## ... Similar to previous best
## Run 10 stress 0.09895552 
## Run 11 stress 0.3767601 
## Run 12 stress 0.09800229 
## Run 13 stress 0.100633 
## Run 14 stress 0.09448819 
## ... Procrustes: rmse 0.0005254494  max resid 0.001867355 
## ... Similar to previous best
## Run 15 stress 0.0989457 
## Run 16 stress 0.1006329 
## Run 17 stress 0.1036753 
## Run 18 stress 0.09448883 
## ... Procrustes: rmse 0.0007961161  max resid 0.002853329 
## ... Similar to previous best
## Run 19 stress 0.09800201 
## Run 20 stress 0.09448735 
## ... Procrustes: rmse 0.0003694067  max resid 0.001323158 
## ... Similar to previous best
## *** Solution reached
```
...
ggplot(data = NMDS, aes(x, y, color = YearTreat)) +
  ...
  geom_polygon(hull.data, mapping = aes(x = x, y = y, fill = YearTreat, group = YearTreat), alpha = 0) +
...
ggplot(aes(x = Stream.Treat, y = Count, fill = Origin)) +
  ...
  labs(title = "Mean Aquatics and Terrestricals in Diets by Reach",
       y = "Mean # in Diet",
       x = "Stream and Reach") +
...
bugndiet %>% 
  ...
  ggplot(aes(x = frac.benthic, y = frac.diet, color = Treatment)) +
    ...
    geom_text_repel(aes(x = frac.benthic, y = frac.diet, label = Family), size = 3, nudge_y = .02) +
    labs(title = "Prop. of Taxa in Benthic Comm. Vs. Prop. in Diets",
         x = "Fraction of Benthic",
         y = "Fraction of Diet") +
    facet_wrap("Stream") +
    scale_color_viridis_d(option = "E") +
    theme(legend.position = c(.84, .27), legend.key.width = unit(5, "cm"),
...
bugndiet %>% 
  ...
  ggplot(aes(x = frac.benthic, y = frac.diet, color = Treatment)) +
    ...
    geom_text_repel(aes(x = frac.benthic, y = frac.diet, label = FFG), size = 4, nudge_y = .02) +
    facet_wrap("Stream") +
...
## ... New best solution
## ... Procrustes: rmse 0.2198102  max resid 0.4823081 
## Run 2 stress 0.1204532 
## ... New best solution
## ... Procrustes: rmse 0.0002300722  max resid 0.0005181422 
## ... Similar to previous best
## Run 3 stress 0.2273011 
## Run 4 stress 0.1284669 
## Run 5 stress 0.1204532 
## ... New best solution
## ... Procrustes: rmse 7.368824e-05  max resid 0.0001553591 
## ... Similar to previous best
## Run 6 stress 0.2340484 
## Run 7 stress 0.1284667 
## Run 8 stress 0.128467 
## Run 9 stress 0.1204533 
## ... Procrustes: rmse 0.0001994993  max resid 0.00042726 
## ... Similar to previous best
## Run 10 stress 0.1284667 
## Run 11 stress 0.1204534 
## ... Procrustes: rmse 0.0003166187  max resid 0.0006813775 
## ... Similar to previous best
## Run 12 stress 0.1204534 
## ... Procrustes: rmse 0.000334292  max resid 0.0007383319 
## ... Similar to previous best
## Run 13 stress 0.171074 
## Run 14 stress 0.1204538 
## ... Procrustes: rmse 0.0004835385  max resid 0.001057611 
## ... Similar to previous best
## Run 15 stress 0.2624483 
## Run 16 stress 0.1284667 
## Run 17 stress 0.1204541 
## ... Procrustes: rmse 0.0002151957  max resid 0.0003023113 
## ... Similar to previous best
## Run 18 stress 0.1284666 
## Run 19 stress 0.1204533 
## ... Procrustes: rmse 0.0002755045  max resid 0.0006090825 
## ... Similar to previous best
## Run 20 stress 0.1204534 
## ... Procrustes: rmse 0.0003269275  max resid 0.000716982 
## ... Similar to previous best
## *** Solution reached
```
