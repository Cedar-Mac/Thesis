...
![](index_files/figure-html/W-113 Total Densities-1.png)<!-- -->
...
![](index_files/figure-html/W-113 Log Ratios-1.png)<!-- -->
...
![](index_files/figure-html/All Streams Total Log Ratios-1.png)<!-- -->


And now the average log ratio across streams for each reach with error bars of 1 standard deviation.
...
![](index_files/figure-html/Total Average Log Ratio-1.png)<!-- -->

And now do it all again for FFG
...
![](index_files/figure-html/W-113 FFG ratios-1.png)<!-- -->
...
![](index_files/figure-html/All FFG ratios-1.png)<!-- -->



```r
ffg.avg.ratio <- data_summary(data = ffg.ratios, varname = "Log(Ratio) Year", 
                                groupnames = c("Treatment", "FFG"))
ffg.avg.ratio %>% 
  ggplot(aes(x = FFG, y = Mean, fill = Treatment)) +
  geom_col(position = "dodge") +
  geom_errorbar(aes(x = FFG, ymin = Mean - SD, ymax = Mean + SD), position = "dodge") +
...
![](index_files/figure-html/Avg FFG ratio-1.png)<!-- -->
...
## Run 1 stress 0.09528869 
## ... New best solution
## ... Procrustes: rmse 0.0003551861  max resid 0.0007603797 
## ... Similar to previous best
## Run 2 stress 0.09800244 
## Run 3 stress 0.1033863 
## Run 4 stress 0.09475043 
## ... New best solution
## ... Procrustes: rmse 0.01810412  max resid 0.05222291 
## Run 5 stress 0.09528874 
## Run 6 stress 0.09750991 
## Run 7 stress 0.09448728 
## ... New best solution
## ... Procrustes: rmse 0.01553948  max resid 0.05700652 
## Run 8 stress 0.0944879 
## ... Procrustes: rmse 0.001042418  max resid 0.003745363 
## ... Similar to previous best
## Run 9 stress 0.0993744 
## Run 10 stress 0.09475836 
## ... Procrustes: rmse 0.01370935  max resid 0.04980593 
## Run 11 stress 0.0944873 
## ... Procrustes: rmse 0.0007899665  max resid 0.002828964 
## ... Similar to previous best
## Run 12 stress 0.09448765 
## ... Procrustes: rmse 0.0001299191  max resid 0.0004007615 
## ... Similar to previous best
## Run 13 stress 0.103388 
## Run 14 stress 0.09800206 
## Run 15 stress 0.09448743 
## ... Procrustes: rmse 6.67675e-05  max resid 0.0001918787 
## ... Similar to previous best
## Run 16 stress 0.09448887 
## ... Procrustes: rmse 0.0004485235  max resid 0.001580239 
## ... Similar to previous best
## Run 17 stress 0.1036778 
## Run 18 stress 0.09750971 
## Run 19 stress 0.103115 
## Run 20 stress 0.09893988 
## *** Solution reached
```
...
## ... New best solution
## ... Procrustes: rmse 0.2197931  max resid 0.4822776 
## Run 2 stress 0.1204533 
## ... New best solution
## ... Procrustes: rmse 8.504428e-05  max resid 0.0001765879 
## ... Similar to previous best
## Run 3 stress 0.128467 
## Run 4 stress 0.1204532 
## ... New best solution
## ... Procrustes: rmse 0.0001464737  max resid 0.0003136806 
## ... Similar to previous best
## Run 5 stress 0.1204538 
## ... Procrustes: rmse 0.0001319441  max resid 0.0002287836 
## ... Similar to previous best
## Run 6 stress 0.1284666 
## Run 7 stress 0.1204532 
## ... New best solution
## ... Procrustes: rmse 2.161034e-05  max resid 3.567569e-05 
## ... Similar to previous best
## Run 8 stress 0.2194268 
## Run 9 stress 0.288142 
## Run 10 stress 0.1284667 
## Run 11 stress 0.1747406 
## Run 12 stress 0.1204533 
## ... Procrustes: rmse 8.870593e-05  max resid 0.0001354018 
## ... Similar to previous best
## Run 13 stress 0.1204532 
## ... Procrustes: rmse 9.283438e-05  max resid 0.0001647928 
## ... Similar to previous best
## Run 14 stress 0.1204532 
## ... Procrustes: rmse 5.093737e-05  max resid 8.241675e-05 
## ... Similar to previous best
## Run 15 stress 0.1204534 
## ... Procrustes: rmse 0.0004107897  max resid 0.0009529038 
## ... Similar to previous best
## Run 16 stress 0.1204532 
## ... New best solution
## ... Procrustes: rmse 8.746089e-06  max resid 1.185218e-05 
## ... Similar to previous best
## Run 17 stress 0.1204532 
## ... Procrustes: rmse 0.0001049522  max resid 0.0002029942 
## ... Similar to previous best
## Run 18 stress 0.1204532 
## ... Procrustes: rmse 7.034261e-05  max resid 0.0001387755 
## ... Similar to previous best
## Run 19 stress 0.1284667 
## Run 20 stress 0.2430237 
## *** Solution reached
```
...
##  [1] plyr_1.8.4        bindrcpp_0.2.2    ggrepel_0.8.0    
...
## [17] Matrix_1.2-14    psych_1.8.4      pkgconfig_2.0.1  broom_0.4.4     
## [21] haven_1.1.1      xtable_1.8-3     scales_1.0.0     later_0.7.5     
## [25] mgcv_1.8-24      withr_2.1.2      lazyeval_0.2.1   cli_1.0.0       
## [29] mnormt_1.5-5     mime_0.6         magrittr_1.5     crayon_1.3.4    
## [33] evaluate_0.10.1  nlme_3.1-139     MASS_7.3-50      xml2_1.2.0      
## [37] foreign_0.8-70   tools_3.5.1      hms_0.4.2        munsell_0.5.0   
## [41] cluster_2.0.7-1  compiler_3.5.1   rlang_0.3.0.1    grid_3.5.1      
## [45] rstudioapi_0.7   htmlwidgets_1.3  crosstalk_1.0.0  labeling_0.3    
## [49] rmarkdown_1.10   gtable_0.2.0     rematch_1.0.1    reshape2_1.4.3  
