...
packages <- c("tidyverse", "vegan", "lubridate", "readxl", "DT")
lapply(packages, library, character.only = TRUE)
```

```{r Import data, include = FALSE}
# import data
bugs <- readxl::read_xlsx("../Bugs/Data/2017-18 bugs.xlsx", sheet = "Cleaned")
ffg <- readxl::read_xlsx("../Bugs/Data/2017-18 bugs.xlsx", sheet = "FFG")
sizes <- readxl::read_xlsx("../Bugs/Data/2017-18 bugs.xlsx", sheet = "Size")
